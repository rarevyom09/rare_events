    ...
    <div className="min-h-screen flex items-center justify-center bg-white py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto space-y-8 md:flex md:items-center">
        <div className="md:w-1/2">
          ...
          {/* <br/> */}
          <img
            className="object-cover h-80 w-full mt-2"
        ...
        <div className="md:w-1/2 m-5">
          ...
          <div>
            <img
              src="images/rarelogoblack.png"
              alt="Your Logo"
              className="mx-auto h-16 mb-4" // Adjust the class to style your logo
            />
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className={`group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white ${isPasswordValid() ? 'bg-indigo-600 hover:bg-indigo-700' : 'bg-gray-300 cursor-not-allowed'}`}
